...
import java.lang.*;
public class Seidel extends AppCompatActivity {
    TextView res,name;
    Button br;
    int a;
    EditText xx1,xx2,xx3,yy1,yy2,yy3,zz1,zz2,zz3,cc1,cc2,cc3,p;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //p=(EditText) findViewById(R.id.oite);
        name.setText("Gauss Seidel");
        res = (TextView) findViewById(R.id.JacobiResult);
        res.setText("This is the Gauss Seidel Iteration Method for Solving Simultaneous Linear Equations.\n"+"Enter the Coefficients of X,Y,Z such that the Coefficents of the leading Diagonal are Large Compared to Others.\n"+
                ...
                try {
                    ...
                    if ((xx1.getText().toString() == "") && (xx2.getText().toString() == "") && xx3.getText().toString() == "" && yy1.getText().toString() == "" && yy2.getText().toString() == "" && yy3.getText().toString() == "" && zz1.getText().toString() == "" && zz2.getText().toString() == "" && zz3.getText().toString() == "" && cc1.getText().toString() == "" && cc2.getText().toString() == "" && cc3.getText().toString() == "") {
                        ...
                        res.setText("Enter All The Coefficients in All The 3 Equations to Proceed");
                           ...
                           // a = Integer.parseInt(p.getText().toString());
                            ...
                            GaussSeidelMethods s = new GaussSeidelMethods();

                        if (((Math.abs(fx1)) > (Math.abs(fy1) + Math.abs(fz1))) && ((Math.abs(fy2)) > (Math.abs(fx2) + Math.abs(fz2))) && ((Math.abs(fz3)) > (Math.abs(fy3) + Math.abs(fx3)))) {

                            String gjop = s.GaussSeidel(fx1, fx2, fx3, fy1, fy2, fy3, fz1, fz2, fz3, fc1, fc2, fc3);
                            res.setText(gjop);
                        }
                        else {

                            res.setText("The Provided Equations Do Not Satisfy The Gauss Seidel Criterion . Please Re Arrange the equations to get The Correct Output. Re Arrange such that the Values in the Leading Diagonal Should be greater than the sum of the other two.\n");
